...
import { fetchVariableContent, getVariableDescriptionAsString, setVariableContent } from "../utility";
  ...
  bIncludeAutoGeneratedVariables = true,
    ...
    try {
      ...
      for (const dbVariable of data) {
        const variableContent = await fetchVariableContent(dbVariable.id);
