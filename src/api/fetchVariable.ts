...
import { Variable, DBVariable, VariableIdToken, VariableContent, DEMOGRAPHICS, VariableFunctions } from "../types";
      ...
      const finalData: Variable[] =
        await data?.reduce<Promise<Variable[]>>(
          async (accPromise, dbVariable: DBVariable) => {
            ...
            VariableFunctions.setInternalMetadata(convertedVariable, {
              _origin: "db",
            })
