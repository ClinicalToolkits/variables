...
import { DBVariable, DBVariableMetadata, InternalVariableMetadata, Variable, VariableContent, VariableData, VariableIdToken, VariableMetadata, wrapVariables } from "../../types";
...
export async function convertDBVariableToVariableData({
  ...
  const convertedVariableData: VariableData = {
    ...
    templateVariableId: template_variable_id
  }

  setVariableContent(convertedVariableData, variableContent);
  console.log("convertedVariable", convertedVariableData);
  console.log("variableContent", variableContent);
  ...
  autoSetClientLocationFromUser(convertedVariableData, callingUser);
...
export function convertVariablePropertiesToDB(variable: Partial<Variable>): Partial<DBVariable> {
  ...
  if (variable.getTemplateVariableId?.() !== undefined) dbVariable.template_variable_id = variable.getTemplateVariableId();
