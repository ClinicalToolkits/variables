 ...
 */
export type AddVariableSetFunction = (inVariableSet: VariableSet, bInIncludeAutoGeneratedVariables?: boolean) => Promise<void>;
 ...
 */
export type RemoveVariableSetFunction = (inVariableSet: VariableSet) => void;
