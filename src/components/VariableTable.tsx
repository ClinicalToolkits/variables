...
import { fetchVariables, fetchVariablesComboboxData, upsertVariable, upsertVariableWithContent } from "../api";
...
export const VariableTable = () => {
  ...
  const variablesArray = getVariablesArray({ inVariableMap: variableMap, bInIncludeAutoGeneratedVariables: false });
