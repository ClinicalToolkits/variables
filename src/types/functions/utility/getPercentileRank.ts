...
const log = logger.scope(SCOPES.types.functions.utility.get_percentile_rank);
...
export const getPercentileRankFromParentVariable = (parentVariable: Variable): string => {
  ...
  if (value === null || value === undefined || (typeof value !== "string" && typeof value !== "number")) {
    log.warn("getPercentileRankFromParentVariable was passed a parent variable that was either null/undefined or not of type string/number, returning: 'Invalid score!'", parentVariable);
