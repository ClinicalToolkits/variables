...
import { DEMOGRAPHICS_PREFIX, USER_INFORMATION_PREFIX, getVariableIdFromString, VariableMap } from "../..";
import { USER_INFORMATION } from "../../variable-ids/USER_INFORMATION"; // Potential circular dependency
import { DEMOGRAPHICS } from "../../variable-ids/DEMOGRAPHICS"; // Potential circular dependency
